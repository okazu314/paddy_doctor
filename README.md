...
ベストの重みを使用した正答率は96.078%であり、20エポック目の重みを使用した正答率は97.770%であった。

チームベストを更新。

### エポックごとの損失
![__results___10_14](output/v28/__results___10_4.png)

### エポックごとのvalidation accuracy
![__results___10_15](output/v28/__results___10_5.png)
